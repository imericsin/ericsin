// ARCHIVED — retired from the live site when CMD+K moved to
// CommandPalette (a cmdk command-palette dialog with a built-in chat
// mode, see src/components/CommandPalette.tsx). Kept here, wired to the
// /prompt-demo route, for a future visual component repo — not used by
// anything live. Its styling (docking, resize-drag, shared-element morph)
// lives in the co-located PromptComponent.archived.css rather than the
// shared stylesheets, so this pair is self-contained and safe to move or
// delete independently of the rest of the site.
import './PromptComponent.archived.css'
...
export const PROMPT_STORAGE_KEY = 'prompt-chat-state-archived-demo'
